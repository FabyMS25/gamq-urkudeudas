...
use app\models\SearchDescargos;
...
/**
 * DescargosController implements the CRUD actions for Descargos model.
 */
class DescargosController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {   
        ...
        $searchModel = new SearchDescargos();
    ...
    /**
     * Delete an existing Descargos model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Descargos model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
