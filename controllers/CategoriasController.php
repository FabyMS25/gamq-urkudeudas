...
use app\models\SearchCategorias;
...
class CategoriasController extends Controller
{
    ...
    {    
        ...
        $searchModel = new SearchCategorias();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        $dataProvider->query->andFilterWhere(['categ_estado'=>1]);
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> $titulo,
                    'content'=>'<span class="text-success">Categoria creada exitosamente.</span>',
                    'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->categ_id]);
            } else {
    ...
    public function actionUpdate($id)
    {
        ...
        $request = Yii::$app->request;
        $model = $this->findModel($id);  
        $titulo = "Actualizar categoria ".$model->categ_nombre;
    ...
    /**
     * Delete an existing Categorias model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Categorias model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
