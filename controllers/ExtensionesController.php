...
use app\models\SearchExtensiones;
...
class ExtensionesController extends Controller
{
    ...
    {    
        ...
        $searchModel = new SearchExtensiones();
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> $titulo,
                    'content'=>'<span class="text-success">Se registro el departamento.</span>',
                    'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->ext_id]);
            } else {
    ...
    /**
     * Delete an existing Extensiones model.
     * For ajax request will return json object
