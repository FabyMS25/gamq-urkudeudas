            ...
            'items' => [
                ...
                'visible' => !Yii::$app->user->isGuest && (Usuario::getRolAdmin()),
                    ...
                    [
                        ...
                        ['label' => 'Resumen General de Recaudaciones',
                        'url' => ['pagos/resumen-general'],
                        ...
                        ['label' => 'Preliquidaciones Graderias o sillas No pagados',
                        'url' => ['pagos/reporte-preliquidacion-nopagados'],
                        //'linkOptions' => ['role' => 'modal-remote'],
                        'visible' => !Yii::$app->user->isGuest && (Usuario::getRolAdmin()),
                        ],
                        '<li class="divider"></li>',
                        '<li class="dropdown-header">Sillas y graderias</li>',
                        ['label' => 'Pagos graderias o sillas por cajeros',
                        'url' => ['pagos/reporte-pagos-graderias-cajeros'],
                        //'linkOptions' => ['role' => 'modal-remote'],
                        'visible' => !Yii::$app->user->isGuest && (Usuario::getRolAdmin()),
                        ],
                        ['label' => 'Anulados graderias o sillas por cajeros',
                        'url' => ['pagos/reporte-anulados-graderias-cajeros'],
                        //'linkOptions' => ['role' => 'modal-remote'],
                        'visible' => !Yii::$app->user->isGuest && (Usuario::getRolAdmin()),
                        ],
                        ['label' => 'Diferencias cobros de graderias o sillas',
                        'url' => ['pagos/reporte-diferencias'],
                        //'linkOptions' => ['role' => 'modal-remote'],
                        'visible' => !Yii::$app->user->isGuest && (Usuario::getRolAdmin()),
                        ],
                        ['label' => 'Graderias Vendidas y Disponibles (mts)',
                        'url' => ['pagos/reporte-espacios-disponibles'],
                        //'linkOptions' => ['role' => 'modal-remote'],
                        'visible' => !Yii::$app->user->isGuest && (Usuario::getRolAdmin()),
                        ],
                        '<li class="divider"></li>',
                        '<li class="dropdown-header">Actividades eventuales</li>',
                        ['label' => 'Sitios Eventuales Pagados',
                        'url' => ['pagos-eventuales/reporte-eventuales-pagados'],
                        //'linkOptions' => ['role' => 'modal-remote'],
                        'visible' => !Yii::$app->user->isGuest && (Usuario::getRolAdmin()),
                        ],
                        ['label' => 'Sitios Eventuales No pagados',
                        'url' => ['pagos-eventuales/reporte-eventuales-nopagados'],
                        //'linkOptions' => ['role' => 'modal-remote'],
                        'visible' => !Yii::$app->user->isGuest && (Usuario::getRolAdmin()),
                        ],
                        ['label' => 'Alasitas Pagados',
                        'url' => ['pagos-eventuales/reporte-alasitas-pagados'],
                        //'linkOptions' => ['role' => 'modal-remote'],
                        'visible' => !Yii::$app->user->isGuest && (Usuario::getRolAdmin()),
                        ],
                        ['label' => 'Alasitas No pagados',
                        'url' => ['pagos-eventuales/reporte-alasitas-nopagados'],
                        //'linkOptions' => ['role' => 'modal-remote'],
                        'visible' => !Yii::$app->user->isGuest && (Usuario::getRolAdmin()),
                        ],
                        ['label' => 'Diferencias cobros de sitios eventuales',
                        'url' => ['pagos/reporte-diferencias-eventuales'],
                        //'linkOptions' => ['role' => 'modal-remote'],
                        'visible' => !Yii::$app->user->isGuest && (Usuario::getRolAdmin()),
                        ],
                        '<li class="divider"></li>',
                        '<li class="dropdown-header">Sentajes</li>',
                        ['label' => 'Reporte preliquidación de sentajes',
                        'url' => ['pagos/reporte-preliquidacion-sentajes'],
                        //'linkOptions' => ['role' => 'modal-remote'],
                        'visible' => !Yii::$app->user->isGuest && (Usuario::getRolAdmin()),
                        ],
                        ['label' => 'Reporte de sentajes pagados',
                        'url' => ['pagos/reporte-sentajes-pagados'],
                        //'linkOptions' => ['role' => 'modal-remote'],
                        'visible' => !Yii::$app->user->isGuest && (Usuario::getRolAdmin()),
                        ],
                        ['label' => 'Reporte de mingitorios pagados',
                        'url' => ['pagos/reporte-mingitorios-pagados'],
                        //'linkOptions' => ['role' => 'modal-remote'],
                        'visible' => !Yii::$app->user->isGuest && (Usuario::getRolAdmin()),
                        ],
                        '<li class="divider"></li>',
                        '<li class="dropdown-header">Reportes de suficiencia</li>',
                        ['label' => 'Reporte de efectividad de graderias o sillas',
                        'url' => ['pagos/reporte-efectividad-graderias'],
                        //'linkOptions' => ['role' => 'modal-remote'],
                        'visible' => !Yii::$app->user->isGuest && (Usuario::getRolAdmin()),
                        ],
                        ['label' => 'Reporte de efectividad de sitios eventuales',
                        'url' => ['pagos/reporte-efectividad-eventuales'],
                        //'linkOptions' => ['role' => 'modal-remote'],
                        'visible' => !Yii::$app->user->isGuest && (Usuario::getRolAdmin()),
                        ],
                        ['label' => 'Reporte de efectividad de alasitas',
                        'url' => ['pagos/reporte-efectividad-alasitas'],
                        //'linkOptions' => ['role' => 'modal-remote'],
                        'visible' => !Yii::$app->user->isGuest && (Usuario::getRolAdmin()),
                        ],
                        ['label' => 'Reporte de efectividad de sentajes',
                        'url' => ['pagos/reporte-efectividad-sentajes'],
                        //'linkOptions' => ['role' => 'modal-remote'],
                        'visible' => !Yii::$app->user->isGuest && (Usuario::getRolAdmin()),
                        ],
                    ],
