...
<div class="descargos-form">
    ...
    <?= $form->field($model, 'desc_fecha_hora')->textInput() ?>

    <?= $form->field($model, 'desc_anulado')->textInput() ?>

    <?= $form->field($model, 'desc_anulado_justificacion')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'desc_anulado_fecha_hora')->textInput() ?>
